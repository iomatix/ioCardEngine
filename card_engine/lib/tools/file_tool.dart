...
class FileTool {
  ...
  static Future<String> getCardEngineBundlerPath() async => 'packages/card_engine';
  ...
  static Future<Uint8List> openFileAsUint8List(String filePath) async {
    try {
  ...
  static Future<File> openFile(String filePath) async {
    try {
      // Get the absolute path of the provided file.
      final absoluteFilePath = File(filePath).absolute.path;
  ...
  static Future<List<int>> byteDataToListInt(ByteData byteData) async {
  ...
  static Future<bool> doesDirectoryExist(String absolutePath) async {
  ...
  ///
  static Future<void> createDirectory(String absolutePath) async {
  ...
  static Future<void> deleteDirectory(String absolutePath) async {
    if (await doesDirectoryExist(absolutePath)) {
  ...
  static Future<void> saveAssetToFile({
  ...
  static Future<void> saveAssetToFileAndOverwrite({
    required String assetPath,
    required String filePath,
  }) async {
    try {
  ...
  static String normalizePathSync(String path) {
    return p.normalize(path);
  }
}
