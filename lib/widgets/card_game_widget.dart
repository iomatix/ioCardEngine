...
class CardGameWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return RiverpodAwareGameWidget (
      game: CardEngine(), key: GlobalKey<RiverpodAwareGameWidgetState<CardEngine>>(debugLabel: '_CardEngine_STATE_'), // (CardEngine based on FlameGame with RiverpodGameMixin)
    );
  }
}
